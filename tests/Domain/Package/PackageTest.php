  ...
  public static function providerConstructionAndGetters(): array {
    return [
      'Full specification' => [
        ...
        'type' => 'library',
        'raw_repository_url' => '/var/www/example_library',
        'install_path' => 'custom/path/to/example_library',
        'version' => '2.x',
        'dev_version' => '2.x-dev',
        'is_extension' => FALSE,
      ...
      'Minimum specification/default values' => [
        ...
        'type' => 'drupal-module',
        'raw_repository_url' => '../example_module',
        'install_path' => 'docroot/modules/contrib/example_module',
        'version' => '*',
        'dev_version' => '*@dev',
        'is_extension' => TRUE,
        'is_module' => TRUE,
      ...
      'Theme' => [
        ...
        'type' => 'drupal-theme',
        'raw_repository_url' => '../example_theme',
        'install_path' => 'docroot/themes/contrib/example_theme',
        'version' => '*',
        'dev_version' => '*@dev',
        'is_extension' => TRUE,
        'is_module' => FALSE,
