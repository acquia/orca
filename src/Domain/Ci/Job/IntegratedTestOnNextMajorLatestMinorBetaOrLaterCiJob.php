...
/**
 * The integrated test on next major, latest minor beta-or-later CI job.
 */
class IntegratedTestOnNextMajorLatestMinorBetaOrLaterCiJob extends AbstractCiJob {
  ...
  protected function jobName(): CiJobEnum {
    return CiJobEnum::INTEGRATED_TEST_ON_NEXT_MAJOR_LATEST_MINOR_BETA_OR_LATER();
  }
