 ...
 * @method static CiJobEnum INTEGRATED_UPGRADE_TEST_FROM_PREVIOUS_MINOR()
...
final class CiJobEnum extends Enum {
  ...
  public const INTEGRATED_UPGRADE_TEST_FROM_PREVIOUS_MINOR = 'INTEGRATED_UPGRADE_TEST_FROM_PREVIOUS_MINOR';
  ...
  public static function descriptions(): array {
    return [
      ...
      self::INTEGRATED_UPGRADE_TEST_FROM_PREVIOUS_MINOR => 'Integrated upgrade test from previous minor Drupal core version',
  ...
  public function getDrupalCoreVersion(): ?DrupalCoreVersionEnum {
    switch ($this->getKey()) {
      ...
      case self::INTEGRATED_UPGRADE_TEST_FROM_PREVIOUS_MINOR:
