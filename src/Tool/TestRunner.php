...
class TestRunner {
   ...
   * The PHPUnit task.
   *
   * @var \Acquia\Orca\Tool\Phpunit\PhpUnitTask
   */
  private $phpunit;
   ...
   *   The output decorator.
   * @param \Acquia\Orca\Tool\Phpunit\PhpUnitTask $phpunit
   *   The PHPUnit task.
   ...
   * Runs the tests.
   *
   * @throws \Acquia\Orca\Helper\Exception\TaskFailureException
   */
   ...
   *
   * @param \Acquia\Orca\Tool\TestFrameworkInterface $framework
   ...
   *
   * @return \Acquia\Orca\Tool\TestFrameworkInterface[]
