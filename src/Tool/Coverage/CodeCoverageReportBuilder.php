...
use Acquia\Orca\Helper\Exception\DirectoryNotFoundException;
use Acquia\Orca\Helper\Exception\FileNotFoundException as OrcaFileNotFoundException;
use Acquia\Orca\Helper\Exception\ParseError as OrcaParseError;
...
class CodeCoverageReportBuilder {
   ...
   *
   * @see \Acquia\Orca\Tool\Phploc\Phploc::PHP_EXTENSIONS
   */
   ...
   *
   * @throws \Acquia\Orca\Helper\Exception\DirectoryNotFoundException
